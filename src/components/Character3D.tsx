...
const MODEL_PATH: Record<CharacterId, string> = {
  ...
  ninja:      '/models/ninja.glb',
  viking:     '/models/viking.glb',
  astronaut:  '/models/astronaut.glb',
  witch:      '/models/witch.glb',
  pirate:     '/models/pirate.glb',
  robot:      '/models/robot.glb',
  samurai:    '/models/samurai.glb',
  angel:      '/models/angel.glb',
  dragon:     '/models/dragon.glb',
  jester:     '/models/jester.glb',
  alchemist:  '/models/alchemist.glb',
...
const ANIM_PROFILE: Record<CharacterId, { height: number; spins: number; squash: number }> = {
  ...
  ninja:      { height: 0.50, spins: 2,   squash: 0.12 },
  viking:     { height: 0.40, spins: 0.5, squash: 0.20 },
  astronaut:  { height: 0.30, spins: 1,   squash: 0.08 },
  witch:      { height: 0.45, spins: 2.5, squash: 0.10 },
  pirate:     { height: 0.50, spins: 1,   squash: 0.18 },
  robot:      { height: 0.20, spins: 0.5, squash: 0.05 },
  samurai:    { height: 0.35, spins: 1,   squash: 0.08 },
  angel:      { height: 0.35, spins: 1.5, squash: 0.06 },
  dragon:     { height: 0.55, spins: 1,   squash: 0.15 },
  jester:     { height: 0.60, spins: 3,   squash: 0.25 },
  alchemist:  { height: 0.40, spins: 2,   squash: 0.12 },
  necromancer: { height: 0.20, spins: 3,  squash: 0.03 },
}
